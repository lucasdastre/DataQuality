from pandera import DataFrameSchema, Check, Index, Column
        ...
        "id_produto": Column(
            ...
            checks=[
                Check.greater_than_or_equal_to(
                    min_value=21.0, raise_warning=False, ignore_na=True
                ),
                Check.less_than_or_equal_to(
                    max_value=30.0, raise_warning=False, ignore_na=True
                ),
            ],
            nullable=False,
            unique=False,
