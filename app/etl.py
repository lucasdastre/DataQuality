...
from app.contrato import schemaCRM, schemaCRMnew
...
@pa.check_output(schemaCRM.to_schema(), lazy=True)
...
def infer_schema(file: str, schema: pa.DataFrameSchema):
    with open(file, "w", encoding="utf-8") as f:
        ...
        f.write(str(schema.to_script()))


@pa.check_output(schemaCRM.to_schema(), lazy=True)
@pa.check_input(schemaCRMnew.to_schema(), lazy=True)
